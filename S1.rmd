...
```{r, fig.cap="Novel introductions per year (grey) and running five-year mean (blue line) from 1800 to 2017"}
...
```{r, fig.cap="Novel introductions per year (grey) and running five-year mean (blue) from 1990 to 2017, according to the Alien Species Lists of 2012 and 2018, respectively"}
