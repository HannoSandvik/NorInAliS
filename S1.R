...
# This code calculates indicator S1 of NorInAliS
...
# as the underlying data are available online
...
lines(2008:2011, rep(22,4), col=grey(0.84), lwd=2.4)
lines(2008:2011, rep(21,4), col=grey(0.84), lwd=1.8, lty=2)
lines(2008:2011, rep(20,4), col="blue",     lwd=4.8)
lines(2008:2011, rep(19,4), col="blue",     lwd=3.6, lty=2)
text(2011, 22, "yearly figures 2018",  pos=4, cex=1.2)
text(2011, 21, "yearly figures 2012",  pos=4, cex=1.2)
text(2011, 20, "five-year means 2018", pos=4, cex=1.2)
text(2011, 19, "five-year means 2012", pos=4, cex=1.2)
box()
